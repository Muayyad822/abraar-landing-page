  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
      ...
      <ScrollAnimation animation="fadeInLeft" delay={0.3}>
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 sm:p-8 rounded-xl shadow-lg border border-blue-400 h-full flex flex-col">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-blue-800">Our Mission</h3>
          </div>
          <p className="text-gray-700 flex-grow">Al-Abraar Academy is dedicated to teaching Qur'anic recitation, memorization, Arabic language, and Islamic
      ...
      <ScrollAnimation animation="fadeInRight" delay={0.3}>
        <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 sm:p-8 rounded-xl shadow-lg border border-green-400 h-full flex flex-col">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-green-800">Our Vision</h3>
          </div>
          <p className="text-gray-700 flex-grow">We envision becoming a leading Islamic academy that produces skilled Qur'an reciters, scholars, and
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
      {/* Students */}
      <div className="bg-white p-6 rounded-xl shadow-md border border-gray-400 text-center">
      ...
      <div className="bg-white p-6 rounded-xl shadow-md border border-gray-400 text-center">
        ...
        <h3 className="text-3xl font-bold text-yellow-600 mb-2">8+</h3>
        <p className="text-gray-600 font-medium">Countries Reached</p>
      </div>
    </div>

    {/* Teaching Methodology */}
    <div className="bg-gray-50 rounded-2xl p-8 md:p-12 border border-gray-400">
